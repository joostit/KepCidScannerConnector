...
namespace ScannerConnector.Http.Xml.Commands
{
    ...
    public partial class CommandOrderRemake : CommandOrder
    {

        private string masterOrderIDField;

        private bool applyRestrictionField;
        ...
        private string remakeCodeIDField;

        private OrderLine[] orderLineField;

        public CommandOrderRemake()
        {
            this.applyRestrictionField = false;
        ...
        public bool ApplyRestriction
        {
            get
            {
                return this.applyRestrictionField;
            }
            set
            {
                this.applyRestrictionField = value;
            }
        }
        ...
        /// <remarks/>
        public string RemakeCodeID
        {
            get
            {
                return this.remakeCodeIDField;
            }
            set
            {
                this.remakeCodeIDField = value;
            }
        }
